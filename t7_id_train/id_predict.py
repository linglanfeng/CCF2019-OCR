...
# id_crnn = CRNN(WEIGHTS_PATH + '/1015_id_only_25-loss-0.007850-acc-0.9976.h5', CHAR_FILE_PATH) # 0.0991050
# id_crnn = CRNN(WEIGHTS_PATH + '/1015_v3_id_only_14-loss-0.002383-acc-0.9990.h5', CHAR_FILE_PATH) # 增加训练数据、减少dftrain在训练集出现频率，增加val df数据概率 #0.099195000
# id_crnn = CRNN(WEIGHTS_PATH + '/1015_id_only_50-loss-0.003156-acc-0.9991.h5', CHAR_FILE_PATH) # 0.099344000
id_crnn = CRNN(WEIGHTS_PATH + '/1021_id_only_33-loss-0.000829-acc-0.9998.h5', CHAR_FILE_PATH) # 效果不错， 对21，错误10 没有提交
# id_crnn = CRNN(WEIGHTS_PATH + '/1021_v2_id_only_83-loss-0.000233-acc-1.0000.h5', CHAR_FILE_PATH) # 一般
# id_crnn = CRNN(WEIGHTS_PATH + '/1021_v2_id_only_67-loss-0.000291-acc-1.0000.h5', CHAR_FILE_PATH) # 一般

# 源路径：下面是子文件夹
src_path = "D:/projects/data/ccf2019_ocr/id_l2/test_img"
# output_path = '../single_result/1015_id_only_50_t1017.csv'
output_path = '../single_result/1021_id_only_33_t1017.csv'
...
test_imgs = [x for x in all_imgs if x.split('/')[-1][-5]=='7']
