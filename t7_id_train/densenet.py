...
def crnn3(input, nclass):
    ...
    m = Bidirectional(GRU(128, return_sequences=True, implementation=2), name='blstm1')(m)
    ...
    m = Bidirectional(GRU(128, return_sequences=True, implementation=2), name='blstm2')(m)
