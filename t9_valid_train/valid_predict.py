...
# id_crnn = CRNN(WEIGHTS_PATH + '/1012_valid_only_200-loss-0.000293-acc-0.9999.h5', CHAR_FILE_PATH)
# id_crnn = CRNN(WEIGHTS_PATH + '/1020_v2_valid_only_100-loss-0.000226-acc-1.0000.h5', CHAR_FILE_PATH) # 效果不错，纠正31，错误6
# id_crnn = CRNN(WEIGHTS_PATH + '/1020_v3_valid_only_39-loss-0.000628-acc-0.9998.h5', CHAR_FILE_PATH) #
id_crnn = CRNN(WEIGHTS_PATH + '/1020_v4_valid_only_29-loss-0.001491-acc-0.9993.h5', CHAR_FILE_PATH) #

# 源路径：下面是子文件夹
src_path = "D:/projects/data/ccf2019_ocr/valid_l2/test_img"
# output_path = '../single_result/1012_valid_only_200.csv'
output_path = '../single_result/1020_v4_valid_only_29_t1017.csv'
...
test_imgs = [x for x in all_imgs if x.split('/')[-1][-5]=='9'] # 注意文件名后缀
