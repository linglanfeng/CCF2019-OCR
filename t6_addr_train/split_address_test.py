...
if __name__ == '__main__':
    ...
    # image_path = 'D:/projects/python/DF_IdCard_Ocr/temp/test'
    # unet_image_path = 'D:/projects/python/DF_IdCard_Ocr/temp/test_unet'
    image_path = 'D:/projects/data/ccf2019_ocr/test_split'
    unet_image_path = 'D:/projects/data/ccf2019_ocr/test_unet_split'
    ...
    error_cnt = 0
    for root, dirs, files in os.walk(unet_image_path):
        for file in files:
            ...
            for idx,text_line in enumerate(sub_images_dict):
                ...
                cv2.imwrite( 'D:/projects/data/ccf2019_ocr/address_l2/test_img/{0}'.format(sub_file_name), des_img[text_line[1]:text_line[3],text_line[0]:text_line[2]])
                cv2.imwrite('D:/projects/data/ccf2019_ocr/address_l2/test_img_unet/{0}'.format(sub_file_name), img[text_line[1]:text_line[3], text_line[0]:text_line[2]])
