...
# output_path = 'result/day_result_mix_ext1w.csv'

src_path = "D:/projects/data/ccf2019_ocr/day_l2/test_img"
output_path = '../single_result/1019_day_only_47.csv'
# 训练权重保存路径
...
test_imgs = [x for x in all_imgs if x.split('/')[-1][-5]=='5']

# 新建并载入模型
model = creatmodel()
# model_path = 'train_model/day_weights/day_mix_weights-net-0100-0.00000629.h5' # 0.09940400000 (当前最优）
# model_path = WEIGHTS_PATH + '/day_mix_ext1w_weights-net-0077-0.00052851.h5'
model_path = WEIGHTS_PATH + '/1019_day_only_47-loss-0.005193-acc-0.9985.h5'
...
for path in test_imgs:
    ...
    if x is not None:
        ...
        y_str = day_list[y_label]    # 民族字符label
