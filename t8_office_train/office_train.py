...
# 训练权重保存路径（作为训练基础）
ADDR_WEIGHTS_PATH = '../x_train_model/address_weights'

# 训练权重保存路径
WEIGHTS_PATH = '../x_train_model/office_weights'

# 数据文件位置
DATA_PATH = 'D:/projects/data/ccf2019_ocr/office_l2'
DF_DATA_PATH = 'D:/projects/data/ccf2019_ocr/office'

# 训练权重日期版本（不要重复）
DATE_VER = '1008'+ '_office'
...
if __name__ == '__main__':
    ...
    # 用地址的权重继续训练
    # modelPath = ADDR_WEIGHTS_PATH + '/1006_address_only_180-loss-0.104651-acc-0.9823.h5'
    modelPath = WEIGHTS_PATH + '/1008_office_only_39-loss-0.105626-acc-0.9752.h5'
    ...
    training_generator = FileImageDataGenerator(data_size = 200000,
                                                ...
                                                df_train_label = DF_DATA_PATH +'/office_lable_by_df_train.txt',
