...
# 训练权重保存路径
WEIGHTS_PATH = '../x_train_model/office_weights/1008_office_only_33-loss-0.090182-acc-0.9882.h5'
...
# 源路径：下面是子文件夹
src_path = "D:/projects/data/ccf2019_ocr/office_l2/test_img"
output_path = '../single_result/1008_office_only_33_l2.csv'
...
def merge_result(result_df):
    ...
    addr_merge_pd = addr_pd.groupby(['file']).apply(lambda x: "".join(x['office'])).reset_index()
    addr_merge_pd.columns=['file','office']
